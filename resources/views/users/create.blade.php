...
<style>
    ...
    select option[value="super_admin"]     { color: #5b21b6; }
    select option[value="kepala_bagian"]   { color: #1d4ed8; }
    select option[value="pengurus_barang"] { color: #166534; }
</style>
@endpush
...
<div style="margin-bottom: 22px;">
    ...
    <h2 style="font-size:22px; font-weight:800; color:var(--text-main); margin:0 0 3px;">Tambah User Baru</h2>
    <p style="font-size:13px; color:var(--text-muted); margin:0;">Isi data berikut untuk mendaftarkan pengguna baru ke sistem</p>
</div>
        ...
        <div class="um-form-body">
            ...
            <div class="um-form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" value="{{ old('username') }}"
                           placeholder="Contoh: budi.santoso" required>
                    <p class="um-hint">Digunakan untuk login, tidak boleh ada spasi.</p>
            ...
            <div class="um-form-row">
                ...
                <div class="form-group">
                    ...
                    <p class="um-hint">Biarkan kosong jika user adalah Super Admin.</p>
